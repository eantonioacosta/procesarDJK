...
public class GestionCeldas extends DefaultTableCellRenderer {
    ...
    private ImageIcon iconoGuardar = new ImageIcon(getClass().getResource("/ICONS/ico_guardar.png"));
    private ImageIcon iconoBuscar = new ImageIcon(getClass().getResource("/ICONS/ico_buscar.png"));
