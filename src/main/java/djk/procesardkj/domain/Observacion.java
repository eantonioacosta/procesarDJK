...
@NamedQueries({
    ...
    @NamedQuery(name = "Observacion.findByTexto", query = "SELECT o FROM Observacion o WHERE o.texto = :texto")})
public class Observacion implements Serializable {
    ...
    public String toString() {
        return "djk.procesardkj.domain.Observacion[ idObservacion=" + idObservacion + " ]";
    }
